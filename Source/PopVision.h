...
//! Project version number for PopVision.
//FOUNDATION_EXPORT double PopCoremlVersionNumber;

//! Project version string for PopVision.
...
//	1.2.0
//		Proper rename of project to PopVision.
//	1.1.3
//		Added SetKinectTrackMode(), as before.
//	1.1.2
//		Added SetKinectGpu() to base class (until we a have better options API)
//	1.1.1
//		added uint64_t timestamp (ms) PopVision::TWorldObject (possibly non-breaking as signatures haven't changed)
