...
{
	ANDROID_ABI=$1
	$ANDROID_NDK/ndk-build -j$MAXCONCURRENTBUILDS NDK_DEBUG=0 NDK_PROJECT_PATH=$SOURCE_ROOT/$PROJECT_NAME.Android/
	...
	SRC_PATH="$PROJECT_NAME.Android/libs/$ANDROID_ABI/$LIBFILENAME"
